...
import { View, StyleSheet, Text, TouchableOpacity, TextInput, FlatList, Dimensions, ActivityIndicator } from 'react-native';
            ...
            <View style={{ marginHorizontal: 20, }}>
                ...
                <TextInput
                    style={[styles.inputStyle, styles.textDefault, {
                        ...
                        borderColor: '#8CC768', fontSize: 16, color: 'black', borderRadius: 20, paddingHorizontal: 20,
                ...
                <TouchableOpacity
                    ...
                    <View>
                        <Text style={[styles.textDefaultBold, { fontSize: 16, }]}>Search</Text>
                    </View>
